...
class JtlParserCoreTest {
    ...
    class SplitCsvLineTests {
        ...
        @Test
        @DisplayName("tab delimiter splits tab-separated values correctly")
        void tabDelimiter() {
            String[] result = JtlParserCore.splitCsvLine("a\tb\tc", '\t');
            assertArrayEquals(new String[]{"a", "b", "c"}, result);
        }
        ...
        @Test
        @DisplayName("tab delimiter — quoted field containing tab treated as single field")
        void tabDelimiterQuotedFieldWithTab() {
            String[] result = JtlParserCore.splitCsvLine("a\t\"b\tc\"\td", '\t');
            assertArrayEquals(new String[]{"a", "b\tc", "d"}, result);
        }

        @Test
        @DisplayName("semicolon delimiter splits correctly")
        ...
        @Test
        @DisplayName("pipe delimiter splits correctly")
        void pipeDelimiter() {
            String[] result = JtlParserCore.splitCsvLine("x|y|z", '|');
