...
class SlaConfigTest {
    ...
    class DisabledTests {
        ...
        @Test
        @DisplayName("isTpsEnabled() returns false")
        void tpsDisabled() {
            assertFalse(SlaConfig.disabled(90).isTpsEnabled());
        }

        @Test
        @DisplayName("tpsThreshold sentinel is -1")
        void tpsThresholdSentinel() {
            assertEquals(-1.0, SlaConfig.disabled(90).tpsThreshold);
        }
    }
