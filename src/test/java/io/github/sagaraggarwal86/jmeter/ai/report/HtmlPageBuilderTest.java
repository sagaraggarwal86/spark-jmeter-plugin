...
class HtmlPageBuilderTest {
    ...
    class BuildPageTests {
        ...
        @Test
        @DisplayName("export bar contains Excel button")
        void exportBarContainsExcelButton() {
            String page = HtmlPageBuilder.buildPage(sevenSectionBody(), "", "", minimalConfig(), "", "", "UNDECISIVE");
            ...
            assertFalse(page.contains("window.print()"), "PDF export button must not be present");
        }
